    ...
    return (
        <>
            ...
            <div className="overflow-x-auto mt-6">
                ...
                <thead className="bg-[#1C2B4A] text-[#ffffff]">
                    <tr>
                    <th className="px-4 py-3">Pasangan</th>
                    <th className="px-4 py-3">Harga Terakhir</th>
                    <th className="px-4 py-3">Perubahan 24jam</th>
                    <th className="px-4 py-3">Tertinggi / Terendah 24jam</th>
                    <th className="px-4 py-3">Kapitalisasi Pasar</th>
                    <th className="px-4 py-3">Volume 24 Jam</th>
                    </tr>
                </thead>
                <tbody className="bg-[#13213F] divide-y divide-[#2E3A59]">
                    <tr>
